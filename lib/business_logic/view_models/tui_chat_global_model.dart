    ...
    if (activeMessageList != null) {
      ...
      if (findeIndex != -1) {
        ...
        if (findeIndex != -1) {
          ...
          bool isUnreadMessage = _receivedUnreadMessageList
              .any((element) => element.msgID == msgID);
  ...
  Future<V2TimValueCallback<V2TimMessage>?>? sendMessageFromController({
    ...
    if (messageInfo != null) {
      ...
      return _sendMessage(
        ...
        offlinePushInfo: offlinePushInfo ??
            tools.buildMessagePushInfo(messageInfo, convID,
                ConvType.values[convType.index], await _getImUserLang(convID)),
      );
    }
    return null;
  }
